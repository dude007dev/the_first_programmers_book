...
- **`14_code_samples.py`** — усі приклади коду з підрозділів книги, зібрані в одному файлі.  
...
- **Окремі програми** — повні приклади, які можна запускати:
  - `14_deposit_profit_program.py` — розрахунок депозиту з обробкою помилок (`try...except`).
