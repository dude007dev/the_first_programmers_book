...
# 17.1 Текст як послідовність символів
...
# 17.3 Функції й методи для тексту
...
# Основні інструменти для роботи з рядками
...
# Форматування та з'єднання рядків
...
print(f"Total price: {price * count}")  # Total price: 150
...
# 17.5 Підготовка до гри “Вгадай слово”
...
# 17.6 Для допитливих: додаткові методи типу даних str
...
# Методи пошуку інформації в рядку
...
# 17.7 Для допитливих: кодування і декодування тексту
