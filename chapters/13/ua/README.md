...
- **13.13 Для допитливих: чи завжди in працює однаково швидко?** → приклади лінійної складності пошуку.  
- **13.14 Для допитливих: чому оператор is іноді поводиться несподівано?** → приклади порівняння обєктів.  
- **13.15 Для допитливих: коротке замикання** → приклади короткого замикання в логічних операторах.  
