# 16. Конструкція try...except

# 16.4 Продовжити програму з урахуванням помилки
...
# 16.8 Приклад: розрахунок депозиту з використанням try..except...
